							    ...
							    <div class="row mb-3">
							      <div class="col-lg-12">
					                    <div class="form-check">
					                        <input type="checkbox" class="form-check-input" name="displayFullName" id="displayFullName" value="1">
					                        <label class="form-check-label" for="displayFullName">Display your <strong>full name</strong> on website.<br /><em>If unselected your name will be displayed as <strong>Firstname L.</strong></em></label>
					                    </div>
							      </div>
							    </div>
							    <div class="row mb-3">
