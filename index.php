	...
	<body>
		...
		<div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
			...
			<div class="carousel-indicators">
				<button data-bs-target="#myCarousel" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
		...
		<?php
			...
			foreach($messages as $msg) {
				if($msg['message_type'] == "Regular") {
					echo('<div class="alert alert-dismissible alert-warning"><button type="button" class="close" data-bs-dismiss="alert">&times;</button>
						<h4>'. $msg['title'] .'</h4>
						<p>' . $msg['message'] . '</p></div>');
				}
				else {
					echo('<div class="alert alert-dismissible alert-danger"><button type="button" class="close" data-bs-dismiss="alert">&times;</button>
						<h4>'. $msg['title'] .'</h4>
						<p>' . $msg['message'] . '</p></div>');
				}
			}
		...
		<div class="container text-center">
			...
			<div class="row">
				<div class="col-lg-4">
					<img class="rounded-pill" src="images/logo_concert.jpg" alt="Upcoming Concert Image" width="140" height="140">
				...
				<div class="col-lg-4">
					<div class="text-center">
						<img class="rounded-pill" src="images/logo_facebook.png" alt="Facebook Image" width="140" height="140">
						<h2>Facebook</h2>
